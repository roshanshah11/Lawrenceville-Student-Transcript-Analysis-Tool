...
def init_routes(app):
    ...
    def extract_grades_route():
        return extract_grades()

# Export functions for external use
__all__ = ['extract_transcript_data', 'parse_grades', 'init_routes','extract_grades','extract_multi_grades']
